...
namespace App.Core.Infrastructure.IDA.Oidc
{
    ...
    public class OpenIdConnectCachingSecurityTokenProvider : IIssuerSecurityKeyProvider
    {
        ...
        private readonly ConfigurationManager<OpenIdConnectConfiguration> _policyConfigurationManager;
        ...
        public OpenIdConnectCachingSecurityTokenProvider(string metadataEndpoint, string policy)
            :this(metadataEndpoint)
        {
            _policyConfigurationManager = new ConfigurationManager<OpenIdConnectConfiguration>($"{metadataEndpoint}?p={policy}", new OpenIdConnectConfigurationRetriever());
            RetrieveMetadata();
        }
