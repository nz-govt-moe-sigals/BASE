...
{
    public class SecurityProfilePermissionController : GuidIdActiveRecordStateODataControllerBase<TenancySecurityProfilePermission, SecurityProfilePermissionDto>
    {
