...
{
    [AllowAnonymous]
    public class CommunityColourSchemeController : GuidIdActiveRecordStateODataControllerBase<CommunityColourScheme, CommunityColourSchemeDto>
    {
        public CommunityColourSchemeController(
        ...
        public IQueryable<CommunityColourSchemeDto> Get()
        {
            IQueryable<CommunityColourSchemeDto> results;

            try
            {
                results =
                    InternalActiveRecords()
                        .ProjectTo<CommunityColourSchemeDto>(
...
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        //[ODataRoute("({key})")]
        public CommunityColourSchemeDto Get(Guid key)
        {
            var result =
                    InternalActiveRecords()
        ...
        //// POST api/values 
        public void Post(CommunityColourSchemeDto value)
        {
            InternalPost(value);
        }

        //// PUT api/values/5 
        public void Put(CommunityColourSchemeDto value)
        {
            InternalPut(value);
        }
    }
