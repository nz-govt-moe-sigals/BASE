namespace App.Module1.Application.Initialization.OData.Implementations
{
    ...
    public abstract class AppModuleODataModelBuilderConfigurationBase<T> : IAppModule1OdataModelBuilderConfiguration, IHasModuleSpecificIdentifier
        where T: class, IHasGuidId, new()
    {
        ...
        //// SKYOUT:public void Define(object builder)
        //{
