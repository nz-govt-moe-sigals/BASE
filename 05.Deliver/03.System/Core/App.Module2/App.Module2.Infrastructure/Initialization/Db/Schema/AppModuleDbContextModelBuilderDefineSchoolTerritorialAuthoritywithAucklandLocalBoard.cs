namespace App.Module02.DbContextModelBuilder
{
    ...
    public class AppModuleDbContextModelBuilderDefineSchoolTerritorialAuthoritywithAucklandLocalBoard : IHasAppModuleDbContextModelBuilderInitializer
    {
        private readonly TenantFKAuditedRecordStatedTimestampedGuidIdReferenceDataConvention _modelBuilderConvention;

        public AppModuleDbContextModelBuilderDefineSchoolTerritorialAuthoritywithAucklandLocalBoard(TenantFKAuditedRecordStatedTimestampedGuidIdReferenceDataConvention modelBuilderConvention)
        {
