namespace App.Module02.Infrastructure.Db.Migrations.Seeding
{
    ...
    public class AppModuleDbContextSeederBodyClaim : IHasAppModuleDbContextSeedInitializer
    {
        private readonly IHostSettingsService _hostSettingsService;

        public AppModuleDbContextSeederBodyClaim(IHostSettingsService hostSettingsService)
        {
