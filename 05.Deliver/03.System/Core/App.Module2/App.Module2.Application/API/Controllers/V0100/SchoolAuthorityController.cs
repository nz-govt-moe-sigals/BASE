namespace App.Module2.Application.ServiceFacade.API.Controllers.V0100
{
    ...
    public class SchoolAuthorityController : GuidIdActiveRecordStateODataControllerBase<SchoolAuthority, SchoolAuthorityDto>
    {
        public SchoolAuthorityController(
        ...
        public IQueryable<SchoolAuthorityDto> Get()
        {
            return InternalGet();
        }

        //[ODataRoute("({key})")]
        public SchoolAuthorityDto Get(Guid key)
        {
            return InternalGet(key);
        }

        //// POST api/values 
        public void Post(SchoolAuthorityDto value)
        {
            InternalPost(value);
        }

        //// PUT api/values/5 
        public void Put(SchoolAuthorityDto value)
        {
            InternalPut(value);
        }
    }
