...
namespace App.Module02.Application.API.Controllers.V0100
{
    public class AccountPermissionController : GuidIdActiveRecordStateODataControllerBase<TenancySecurityProfilePermission, AccountPermissionDto>
    {
        ...
        public IQueryable<AccountPermissionDto> Get()
        {
            IQueryable<AccountPermissionDto> results;

            try
            {
                results =
                    InternalActiveRecords()
                        .ProjectTo<AccountPermissionDto>(
...
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        //[ODataRoute("({key})")]
        public AccountPermissionDto Get(Guid key)
        {
            var result =
                    InternalActiveRecords()
        ...
        //// POST api/values 
        public void Post(AccountPermissionDto value)
        {
            InternalPost(value);
        }

        //// PUT api/values/5 
        public void Put(AccountPermissionDto value)
        {
            InternalPut(value);
        }
    }
