...
{
    public class AccountRoleGroupController : GuidIdActiveRecordStateODataControllerBase<TenancySecurityProfileRoleGroup, AccountRoleGroupDto>
    {
        public AccountRoleGroupController(
        ...
        public IQueryable<AccountRoleGroupDto> Get()
        {
            IQueryable<AccountRoleGroupDto> results;

            try
            {
                results =
                    InternalActiveRecords()
                        .ProjectTo<AccountRoleGroupDto>(
...
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        //[ODataRoute("({key})")]
        public AccountRoleGroupDto Get(Guid key)
        {
            var result =
                    InternalActiveRecords()
        ...
        //// POST api/values 
        public void Post(AccountRoleGroupDto value)
        {
            InternalPost(value);
        }

        //// PUT api/values/5 
        public void Put(AccountRoleGroupDto value)
        {
            InternalPut(value);
        }
    }
