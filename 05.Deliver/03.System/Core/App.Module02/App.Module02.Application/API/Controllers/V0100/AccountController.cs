...
{
    public class AccountController : GuidIdActiveRecordStateODataControllerBase<Shared.Models.Entities.TenancySecurityProfile, AccountDto>
    {
...
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        //[ODataRoute("({key})")]
        public AccountDto Get(Guid key)
        {
            var result =
                    InternalActiveRecords()
        ...
        //// POST api/values 
        public void Post(AccountDto value)
        {
            InternalPost(value);
        }

        //// PUT api/values/5 
        public void Put(AccountDto value)
        {
            InternalPut(value);
        }
    }
