namespace App.Module2.Application.ServiceFacade.API.Controllers
{
        ...
        where TDto : class, IHasGuidId, new()
    {
        ...
        {
            return this._repositoryService.GetQueryableSet<TEntity>(AppModule1DbContextNames.Module1);
        }
        ...
        protected void InternalPut(TDto value)
        {
            ...
            this._repositoryService.AddOnCommit(AppModule1DbContextNames.Module1, entity);
        }
