namespace App.Module80.Infrastructure.Initialization.Db.Migrations
{
    ...
    public partial class EntitiesInit : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        BackOfBeach = c.String(maxLength: 64),
                        Length = c.Decimal(nullable: false, precision: 7, scale: 2),
                        Width = c.Decimal(precision: 7, scale: 2),
                        SubstratumType = c.String(maxLength: 64),
                        SubstrateUniformity = c.String(maxLength: 64),
                        TidalDistance = c.Decimal(precision: 7, scale: 2),
                        TidalRange = c.Decimal(precision: 7, scale: 2),
                        NearestTown = c.String(maxLength: 64),
                        NearestTownDirection = c.String(maxLength: 64),
                        NearestTownDistance = c.Decimal(precision: 7, scale: 2),
                        NearestRiverName = c.String(maxLength: 64),
                        NearestRiverDirection = c.String(maxLength: 64),
                        NearestRiverDistance = c.Decimal(precision: 7, scale: 2),
                        RiverInputName = c.String(maxLength: 64),
                        PipesOrDrainsInput = c.Boolean(),
                ...
                c => new
                    {
                        ...
                        DeletedByPrincipalId = c.String(maxLength: 32),
                        Name = c.String(nullable: false, maxLength: 64),
                        NumberOfPersonsInvolved = c.Int(),
                        StartTime = c.DateTime(),
                        StartLongitude = c.Decimal(precision: 10, scale: 7),
                        StartLatitude = c.Decimal(precision: 10, scale: 7),
                        EndTime = c.DateTime(),
                        EndLongitude = c.Decimal(precision: 10, scale: 7),
                        EndLatitude = c.Decimal(precision: 10, scale: 7),
                        BeachFK = c.Guid(nullable: false),
                        OrganisationFK = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("Module80.Organisations", t => t.OrganisationFK, cascadeDelete: true)
                .ForeignKey("Module80.SurveyLocations", t => t.BeachFK)
        ...
        {
            DropForeignKey("Module80.Surveys", "BeachFK", "Module80.SurveyLocations");
            ...
            DropIndex("Module80.Surveys", new[] { "BeachFK" });
