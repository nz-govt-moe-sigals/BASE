...
{
    public class SurveysController : ActiveRecordStateODataControllerBase
        <Survey, SurveyDto>
    {
        public SurveysController(IDiagnosticsTracingService diagnosticsTracingService, IPrincipalService principalService, IRepositoryService repositoryService, IObjectMappingService objectMappingService, ISecureAPIMessageAttributeService secureApiMessageAttribute) 
