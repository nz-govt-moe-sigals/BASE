...
//    public abstract class ActiveRecordStateODataControllerBase<TEntity, TDto, TDtoId> : ODataControllerBase
//        where TEntity : class, IHasRecordState, new()
//        where TDto : class, IHasId<TDtoId>, new()
//        where TDtoId : struct
//    {
...
//        protected TDto InternalGet(TDtoId key)
//        {
//            var result  =
//                InternalActiveRecords()
//                .ProjectTo<TDto>()
