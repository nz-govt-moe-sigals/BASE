namespace App.Core.Application.ServiceFacade.API.Controllers
{
    ...
    public abstract class TenantedActiveRecordStateODataControllerBase<TEntity, TDto> : ODataControllerBase
        ...
        where TDto : class, IHasGuidId, new()
    {
        ...
        protected TenantedActiveRecordStateODataControllerBase(IDiagnosticsTracingService diagnosticsTracingService,
            IRepositoryService repositoryService, IObjectMappingService objectMappingService, ISecureAPIMessageAttributeService secureApiMessageAttribute, IPrincipalService principalService, ITenantService tenantService ) : base(diagnosticsTracingService, principalService)
        {
        ...
        protected IQueryable<TEntity> InternalGetDbSet()
        {
            ...
            return this._repositoryService.GetQueryableSet<TEntity>(this._dbContextIdentifier).Where(x=>(x.TenantFK == tenantFK));
        }
