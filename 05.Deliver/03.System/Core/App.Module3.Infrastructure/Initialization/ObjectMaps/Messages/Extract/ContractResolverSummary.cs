...
{
    public class ContractResolverSummary : BaseMessageContractResolver<Summary>
    {
        public ContractResolverSummary() :base()
        {
            AddMap(x => x.SchoolDirectoryId, "School_Directory_Id");
            ...
            AddMap(x => x.SourceDataLastModifiedEnrol, "SourceDataLastModified_Enrol");
            AddMap(x => x.SourceDataLastModifiedSchoolProfiles, "SourceDataLastModified_School_Profiles");
            AddMap(x => x.SourceDataLastModifiedWgs, "SourceDataLastModified_WGS");
        }
    }
}
