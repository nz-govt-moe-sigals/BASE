...
namespace App.Module3.Infrastructure.Initialization.ObjectMaps.Extract
{
    ...
    /// </summary>
    public class ObjectMap_ReferenceSchoolClassification_EducationProviderClassification : IHasAutomapperInitializer
    {
        public void Initialize(IMapperConfigurationExpression config)
        {
            config.CreateMap<ReferenceSchoolClassification, EducationProviderClassification>();
            config.CreateMap<EducationProviderClassification, EducationProviderClassification>();
        }
    }
}
