...
namespace App.Module3.Infrastructure.Services.Implementations.Configuration
{
    ...
    {
        private readonly IDictionary<Type, IDictionary<string, TenantedFIRSTSIFKeyedGuidIdReferenceDataBase>> _lookDictionary;

        public ExtractCachedRepoObject()
        {
            _lookDictionary = new Dictionary<Type, IDictionary<string, TenantedFIRSTSIFKeyedGuidIdReferenceDataBase>>();
        }

        public IDictionary<string, TenantedFIRSTSIFKeyedGuidIdReferenceDataBase> GetCachedLookUpData<T>()
        {
        ...
        public void CacheLookUpData<T>(IDictionary<string, TenantedFIRSTSIFKeyedGuidIdReferenceDataBase> dic)
        {
