...
namespace App.Module11.Infrastructure.Db.Schema
{
    ...
    public class AppModule11DbContextModelBuilderDefineGeneralElectorate : IHasAppModule11DbContextModelBuilderInitializer
    {
        private readonly TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention _modelBuilderConvention;
        
        public AppModule11DbContextModelBuilderDefineGeneralElectorate(TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention modelBuilderConvention)
        {
