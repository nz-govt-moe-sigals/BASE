...
namespace App.Module11.Infrastructure.Db.Schema
{
    ...
    public class AppModule11DbContextModelBuilderDefineOrganisationStatus : IHasAppModule11DbContextModelBuilderInitializer
    {
        private readonly TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention _modelBuilderConvention;

        public AppModule11DbContextModelBuilderDefineOrganisationStatus(TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention modelBuilderConvention)
        {
