...
namespace App.Module11.Infrastructure.Db.Schema
{
    ...
    public class AppModule11DbContextModelBuilderDefineEducationProviderLevelGender : IHasAppModule11DbContextModelBuilderInitializer
    {
        
        private readonly TenantFKAuditedRecordStatedTimestampedGuidIdDataConvention _modelBuilderConvention;

        public AppModule11DbContextModelBuilderDefineEducationProviderLevelGender(
