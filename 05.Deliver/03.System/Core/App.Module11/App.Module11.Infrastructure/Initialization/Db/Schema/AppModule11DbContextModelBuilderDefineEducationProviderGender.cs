...
namespace App.Module11.Infrastructure.Db.Schema
{
    ...
    public class AppModule11DbContextModelBuilderDefineEducationProviderGender : IHasAppModule11DbContextModelBuilderInitializer
    {
        private readonly TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention _modelBuilderConvention;

        public AppModule11DbContextModelBuilderDefineEducationProviderGender(TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention modelBuilderConvention)
        {
