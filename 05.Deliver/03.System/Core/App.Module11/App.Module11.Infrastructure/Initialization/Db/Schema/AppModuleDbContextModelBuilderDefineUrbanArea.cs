...
namespace App.Module11.Infrastructure.Db.Schema
{
    ...
    public class AppModuleDbContextModelBuilderDefineUrbanArea : IHasAppModuleDbContextModelBuilderInitializer
    {
        private readonly TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention _modelBuilderConvention;

        public AppModuleDbContextModelBuilderDefineUrbanArea(TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention modelBuilderConvention)
        {
