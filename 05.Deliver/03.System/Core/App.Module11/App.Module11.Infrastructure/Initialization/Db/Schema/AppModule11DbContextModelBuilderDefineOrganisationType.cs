...
namespace App.Module11.Infrastructure.Db.Schema
{
    ...
    public class AppModule11DbContextModelBuilderDefineOrganisationType : IHasAppModule11DbContextModelBuilderInitializer
    {
        private readonly TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention _modelBuilderConvention;

        public AppModule11DbContextModelBuilderDefineOrganisationType(TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention modelBuilderConvention)
        {
