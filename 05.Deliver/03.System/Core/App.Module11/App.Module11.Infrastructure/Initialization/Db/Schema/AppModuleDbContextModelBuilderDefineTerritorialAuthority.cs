...
namespace App.Module11.Infrastructure.Db.Schema
{
    ...
    public class AppModuleDbContextModelBuilderDefineTerritorialAuthority : IHasAppModuleDbContextModelBuilderInitializer
    {
        private readonly TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention _modelBuilderConvention;

        public AppModuleDbContextModelBuilderDefineTerritorialAuthority(TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention modelBuilderConvention)
        {
