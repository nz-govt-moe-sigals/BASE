...
namespace App.Module11.Infrastructure.Db.Schema
{
    ...
    public class AppModuleDbContextModelBuilderDefineOrganisationType : IHasAppModuleDbContextModelBuilderInitializer
    {
        private readonly TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention _modelBuilderConvention;

        public AppModuleDbContextModelBuilderDefineOrganisationType(TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention modelBuilderConvention)
        {
