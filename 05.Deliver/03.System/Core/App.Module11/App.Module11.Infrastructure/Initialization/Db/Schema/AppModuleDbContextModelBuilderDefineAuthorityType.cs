...
namespace App.Module11.Infrastructure.Db.Schema
{
    ...
    public class AppModuleDbContextModelBuilderDefineAuthorityType : IHasAppModuleDbContextModelBuilderInitializer
    {
        private readonly TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention _modelBuilderConvention;

        public AppModuleDbContextModelBuilderDefineAuthorityType(TenantedSIFSourceSystemKeyedGuidIdReferenceDataConvention modelBuilderConvention)
        {
