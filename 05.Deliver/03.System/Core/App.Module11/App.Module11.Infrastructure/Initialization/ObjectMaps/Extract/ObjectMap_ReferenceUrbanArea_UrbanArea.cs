...
namespace App.Module11.Infrastructure.Initialization.ObjectMaps.Extract
{
    ...
    /// </summary>
    public class ObjectMap_ReferenceUrbanArea_UrbanArea : IHasAutomapperInitializer
    {
        public void Initialize(IMapperConfigurationExpression config)
        {
            config.CreateMap<ReferenceUrbanArea, UrbanArea>();
            config.CreateMap<UrbanArea, UrbanArea>();
        }
    }
}
