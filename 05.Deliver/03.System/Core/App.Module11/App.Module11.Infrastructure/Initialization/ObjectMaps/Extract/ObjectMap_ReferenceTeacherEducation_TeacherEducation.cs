...
namespace App.Module11.Infrastructure.Initialization.ObjectMaps.Extract
{
    ...
    /// </summary>
    public class ObjectMap_ReferenceTeacherEducation_TeacherEducation : IHasAutomapperInitializer
    {
        public void Initialize(IMapperConfigurationExpression config)
        {
            config.CreateMap<ReferenceTeacherEducation, TeacherEducation>();
            config.CreateMap<TeacherEducation, TeacherEducation>();
        }
    }
}
