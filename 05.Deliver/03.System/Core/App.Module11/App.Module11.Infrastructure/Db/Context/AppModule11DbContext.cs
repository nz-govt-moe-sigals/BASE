namespace App.Module11.Infrastructure.Db.Context
{
    ...
    using App.Module11.Infrastructure.Db.Schema;
    ...
    [Alias(Constants.Db.AppModule11DbContextNames.Module11)]
    public class AppModule11DbContext : AppDbContextBase
    {
        ...
        //static AppModule11DbContext()
        //{
        //    PowershellServiceLocatorConfig.Initialize();
        //    //Database.SetInitializer(new AppModule11DatabaseInitializer());
        //    //AppModule11DatabaseInitializerConfigurer.Configure();
        //}
        ...
        public AppModule11DbContext() : base(AppCoreDbConnectionStringNames.Default)
        {
        }

        public AppModule11DbContext(string connectionStringOrName) : base(connectionStringOrName)
        {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            AppDependencyLocator.Current.GetInstance<AppModule11DbModelBuilderOrchestrator>()
