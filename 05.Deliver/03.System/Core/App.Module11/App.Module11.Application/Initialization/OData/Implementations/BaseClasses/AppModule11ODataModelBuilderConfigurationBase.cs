...
namespace App.Module11.Application.Initialization.OData.Implementations
{
    ...
    public abstract class AppModule11ODataModelBuilderReferenceDataConfigurationBase<T> : IAppModule11OdataModelBuilderConfiguration
        where T: class, IHasId<string>,  new()
    {
        private readonly string _controllerName;

        protected AppModule11ODataModelBuilderReferenceDataConfigurationBase(string controllerName)
        {
