...
//namespace App.Module11.Application.Services.Implementations
//{
//    public class TaskService : ITaskService
//    {
//        public OIDCConfiguration Configuration;

//        private readonly IOIDCConfigurationService _oidcConfigurationService;

//        private readonly ITaskService _taskService;
//        private String apiEndpoint = Startup.ServiceUrl + "/api/tasks/";


//        public TaskService(IOIDCConfigurationService oidcConfigurationService )
//        {
//            _oidcConfigurationService = oidcConfigurationService;

//            Configuration = _oidcConfigurationService.GetOidcConfiguration();
//        }
...
//                //App.Core.Infrastructure.IDA.Constants.HostSettingsKeys.ApiScopes.ApiExampleReadScope 
//                var scope = new string[] { Startup.ReadTasksScope };
//                string signedInUserID = ClaimsPrincipal.Current.FindFirst(ClaimTypes.NameIdentifier).Value;
//                TokenCache userTokenCache = new MSALSessionCache(signedInUserID, this.HttpContext).GetMsalCacheInstance();
//                ConfidentialClientApplication cca = new ConfidentialClientApplication(Configuration.ClientId, Startup.Authority, Startup.RedirectUri, new ClientCredential(Startup.ClientSecret), userTokenCache, null);
