...
namespace App.Module3.Infrastructure.Initialization.ObjectMaps.Extract
{
    ...
    /// </summary>
    public class ObjectMap_ReferenceOrganisationType_EducationProviderType : IHasAutomapperInitializer
    {
        public void Initialize(IMapperConfigurationExpression config)
        {
            config.CreateMap<ReferenceOrganisationType, EducationProviderType>();
            config.CreateMap<EducationProviderType, EducationProviderType>();
        }
    }
}
