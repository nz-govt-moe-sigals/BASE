...
namespace App.Module3.Infrastructure.Initialization.ObjectMaps.Extract
{
    ...
    /// </summary>
    public class ObjectMap_ReferenceOrganisationStatus_EducationProviderStatus : IHasAutomapperInitializer
    {
        public void Initialize(IMapperConfigurationExpression config)
        {
            config.CreateMap<ReferenceOrganisationStatus, EducationProviderStatus>();
            config.CreateMap<EducationProviderStatus, EducationProviderStatus>();
        }
    }
}
