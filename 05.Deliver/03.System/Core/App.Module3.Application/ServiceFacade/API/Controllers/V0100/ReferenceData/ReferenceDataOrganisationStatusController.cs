namespace App.Module3.Application.ServiceFacade.API.Controllers.V0100
{
    ...
    public class OrganisationStatusController : ODataControllerStandardDataBase<OrganisationStatus, OrganisationStatusDto>
    {
        public OrganisationStatusController(
        ...
        //[ODataRoute("({key})")]
        public OrganisationStatusDto Get(Guid key)
        {
            return InternalGet(key);
        }

        //// POST api/values 
        public void Post(OrganisationStatusDto value)
        {
            InternalPost(value);
        }

        //// PUT api/values/5 
        public void Put(OrganisationStatusDto value)
        {
            InternalPut(value);
        }
    }
