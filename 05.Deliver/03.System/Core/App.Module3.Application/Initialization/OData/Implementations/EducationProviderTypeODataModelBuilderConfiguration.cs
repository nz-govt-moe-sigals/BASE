namespace App.Module3.Application.Initialization.OData.Implementations
{
    ...
    public class EducationProviderTypeODataModelBuilderConfiguration : AppModule3ODataModelBuilderReferenceDataConfigurationBase<EducationProviderOrganisationTypeDto>
    {
