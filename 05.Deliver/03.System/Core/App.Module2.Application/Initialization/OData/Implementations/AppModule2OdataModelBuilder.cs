namespace App.Module2.Application.Initialization.OData.Implementations
{
    ...
    /// OData Models.
    /// </summary>
    public class AppModule2OdataModelBuilder : IAppModule2OdataModelBuilder
    {
        ...
        private int RegisterByReflectionTheODataModelDefinitions(ODataModelBuilder builder)
        {
            ...
            var items = AppDependencyLocator.Current
                ...
                .Where(x=>x is IAppModule2OdataModelBuilderConfiguration).ToArray();
