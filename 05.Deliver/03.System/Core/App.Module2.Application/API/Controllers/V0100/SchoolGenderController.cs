namespace App.Module2.Application.ServiceFacade.API.Controllers.V0100
{
    ...
    public class SchoolGenderController : GuidIdActiveRecordStateODataControllerBase<SchoolGender, SchoolGenderDto>
    {
        public SchoolGenderController(
        ...
        public IQueryable<SchoolGenderDto> Get()
        {
            return InternalGet();
        }

        //[ODataRoute("({key})")]
        public SchoolGenderDto Get(Guid key)
        {
            return InternalGet(key);
        }

        //// POST api/values 
        public void Post(SchoolGenderDto value)
        {
            InternalPost(value);
        }

        //// PUT api/values/5 
        public void Put(SchoolGenderDto value)
        {
            InternalPut(value);
        }
    }
