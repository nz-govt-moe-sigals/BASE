namespace App.Module2.Application.ServiceFacade.API.Controllers
{
        ...
        where TDto : class, IHasGuidId, new()
    {
        ...
        {
            return this._repositoryService.GetQueryableSet<TEntity>(AppModule2DbContextNames.Module2);
        }
        ...
        protected void InternalPut(TDto value)
        {
            ...
            this._repositoryService.AddOnCommit(AppModule2DbContextNames.Module2, entity);
        }
...
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        public void InternalLogicalDelete(Guid key)
        {
