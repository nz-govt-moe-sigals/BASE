...
# README
  ...
  * https://github.com/Microsoft/vsts-tasks/blob/master/docs/authoring/commands.md
  ...
  #>
    ...
    $linkedResourcesArmTemplateRootSas = $env:custom_task_vars_armTemplateRootSas;
    if ([string]::IsNullOrWhiteSpace($linkedResourcesArmTemplateRootSas)) {$linkedResourcesArmTemplateRootSas = ""; }
    if ($linkedResourcesArmTemplateRootSas.StartsWith("?") -eq $false) {
        $linkedResourcesArmTemplateRootSas = ""; 
        Write-Host "linkedResourcesArmTemplateRootSas did not start with ?...stripping out."
    }
    ...
    if ([string]::IsNullOrWhiteSpace($armTemplateParameterRootSas)) {
        $armTemplateParameterRootSas = $linkedResourcesArmTemplateRootSas; 
        Write-Host "Blank, therefore setting armTemplateParameterRootSas to linkedResourcesArmTemplateRootSas."
    }
    ...
    if ([System.IO.Path]::IsPathRooted($armTemplatePath) -eq $false) {
        ...
        $armTemplatePath = [System.IO.Path]::Combine($armTemplateRootUrl, $armTemplatePath, $linkedResourcesArmTemplateRootSas)
    }         
    ...
    Write-Host "...armTemplateRootUrl: $armTemplateRootUrl"
    Write-Host "...linkedResourcesArmTemplateRootSas: $linkedResourcesArmTemplateRootSas"
    ...
    `
        ...
        -linkedResourcesArmTemplateRootSas $linkedResourcesArmTemplateRootSas `
    ...
    Write-Host "##vso[task.setvariable variable=custom_task_vars_armTemplateRootSas;]$linkedResourcesArmTemplateRootSas"
